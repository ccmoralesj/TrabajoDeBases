...
tipo varchar2(1) not null check(tipo='d' or tipo = 'l')
);
...
CREATE TABLE domicilio(
manicurista references manicurista,
domFecHora DATETIME references cita,
direccion varchar2(20) not null,
primary key(manicurista,domFecHora)
);
CREATE TABLE spa(
manicurista references manicurista,
spaFecHora DATETIME references cita,
primary key(manicurista,spaFecHora)
);
--------------------------------------------------------------
...
tipo varchar2(1) not null check(tipo='p' or tipo = 'h')
);
